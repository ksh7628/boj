 ...
 * 혼자 품: X
 * 풀이: 
 * 1. 구간 합을 저장하는 tree 배열을 선언해서 최초 구간 합을 저장한다.
 * 2. a = 1일 경우, 세그먼트 트리의 수를 변경해서 구간 합을 갱신한다.
 * 3. a = 2일 경우, 주어진 구간 합이 저장된 인덱스를 찾아서 합을 구한다.
 * 느낀 점: 세그먼트 트리 기본 문제로 익숙해지기까지 코드를 많이 참조해야겠다고 느낌.
 */
